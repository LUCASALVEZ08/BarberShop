...
-- DropForeignKey
ALTER TABLE "Booking" DROP CONSTRAINT "Booking_seerviceId_fkey";
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_seerviceId_fkey" FOREIGN KEY ("seerviceId") REFERENCES "Service"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
