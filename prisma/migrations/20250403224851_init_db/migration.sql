...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_seerviceId_fkey" FOREIGN KEY ("seerviceId") REFERENCES "BarbershopService"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
